		...
		<?php else : ?>
			<section class="col-lg-7">
				<table class="table table-bordered table-condensed">
					...
					<tr><th>Hostel No: </th><td><?php if(isset($hname)) echo $hname; ?></td></tr>

					<tr><th>Room No: </th><td><?php if(isset($rno)) echo $rno; ?></td></tr>
					<tr><th>Year Of study: </th><td><?php if(isset($yos)) echo $yos; ?></td></tr>
					<tr><th>Address No: </th><td><?php if(isset($address)) echo $address; ?></td></tr>
					<tr><th>Mob No: </th><td><?php if(isset($mob)) echo $mob; ?></td></tr>

					<tr><th>cgpa: </th><td><?php if(isset($cgpa)) echo $cgpa; ?></td></tr>
